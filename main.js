Vue.createApp({
  data() {
    return {
      ...
      header: {
        title: "Weni Sepriani",
        desc: "Seorang mahasiswi program studi Sistem Informasi Universitas Ahmad Dahlan angkatan tahun 2020. Masih sangat baru dalam hal coding, masih perlu banyak belajar dan referensi.",
